...
## 메시지 큐
1. 메시지 큐:
![image](https://github.com/sungbinlee/sungbinlee.github.io/assets/52542229/4d77c7cf-5053-473c-b0d7-9e33cadf0603)
...
**수직적 확장**
스케일업으로, 이 방법은 단일 서버의 성능을 향상시키는 방법입니다. 더 많은 고성능 자원을 추가하여 부하를 줄이는 것입니다. 
...
**수평적 확장**
수평적 확장은 더 많은 서버를 추가하여 성능을 향상시키는 방법입니다. 여기서 중요한 개념이 "샤딩(Sharding)"입니다.
![image](https://github.com/sungbinlee/sungbinlee.github.io/assets/52542229/a09bc0e8-f11c-4c6a-be54-5f1a2b8ee222)

- **샤딩**: 대규모 데이터베이스를 작은 단위인 샤드로 분할하는 것을 의미합니다. 각 샤드는 같은 스키마를 사용하지만 데이터는 중복되지 않습니다.

![image](https://github.com/sungbinlee/sungbinlee.github.io/assets/52542229/0bb312f3-6856-4f5a-905a-ffb6e9e0271f)
